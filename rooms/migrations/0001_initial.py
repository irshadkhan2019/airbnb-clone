# Generated by Django 2.2.5 on 2023-04-02 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', models.ManyToManyField(null=True, to='rooms.Amenity')),
                ('facilities', models.ManyToManyField(null=True, to='rooms.Facility')),
                ('house_rules', models.ManyToManyField(null=True, to='rooms.HouseRule')),
